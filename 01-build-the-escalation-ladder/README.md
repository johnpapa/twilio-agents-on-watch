...
That's the whole pattern this chapter builds: **text, wait, escalate to a
call if ignored, keep waiting, return whatever the human decided.** Every
later chapter is about making one piece of this real. This chapter is about
...
you're running this with Claude Code or another coding agent, this chapter
...
and confirm the output matches what's described in this chapter's README."*
