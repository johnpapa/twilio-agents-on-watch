...
4. askHuman places a real text and, if unanswered, a real phone call, then always returns a decision -- call it AT MOST ONCE regardless of what it returns, even if the human never replied at all. Never call it a second time.
